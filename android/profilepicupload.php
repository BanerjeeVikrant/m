...
if(isset($_POST['image'])){
	...
	$sql = "UPDATE users SET profile_pic='userdata/pictures/$usernameid/$id.jpg' AND bannerimg='userdata/pictures/$usernameid/thumbnail/$id.jpg' WHERE username='$username'";
